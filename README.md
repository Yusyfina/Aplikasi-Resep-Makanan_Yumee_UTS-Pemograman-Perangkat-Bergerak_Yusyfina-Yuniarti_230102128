...
Flutter SDK	Framwork Utama	3.38.3
Dart	Bahasa pemograman	3.10.1
Asset lokal	Gambar Resep dan Bahan	-
Hive	Menyimpan data lokal	2.2.3

# INSTALLASI & MENJALANKAN APLIKASI 
1. Clone Repository 
git clone https://github.com/username/yumee.git 
2. Masuk ke folder project 
cd yumee 
3. Install dependencies 
flutter pub get 
4. Generate Hive Adapter (Jika pakai) 
...
Mnenampilkan detail resep seperti bahan dan langkah. 
